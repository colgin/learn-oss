...
(async () => {
	...
	// 从package.json中获取输出的配置，Array<{ outputPath: string, type: 'module' | 'commonjs' | 'type', platform: string, isExecutable: boolean, from: string }>
	...
	// peer + optional + dependencies都要external掉
